 ...
 * This factory allows us to customise our MongoDB storage, everything else is the same as the
 * original. See "Application\Auth\Storage\MongoAdapter" for the customised version.
 */
