...
namespace Application\Api\Paginator\Adapter;
...
/**
 * Copied from DoctrineMongoODMModule
 *
 * I only ever used this class and the module caused composer some indigestion!
 *
 * @license MIT
